...
def input_parser(misc_inputs_path, dss_path, load_solar_path, breakpoints_path=None, benchmark=False, percentage_hack=0.45, adv=False):
    ...
    Args:
        misc_inputs_path (str): directory to miscellaneous settings for the experiment. Example can be found at ./data/ieee37busdata/misc_inputs.csv
        dss_path (str): directory to .dss file. Example can be found at ./data/ieee37busdata/ieee37.dss
        load_solar_path (str): directory to load and solar profiles for different inverters. Example can be found at ./data/ieee37busdata/load_solar_data.csv
        breakpoints_path (str, optional): directory to default settings of different inverters. Defaults to None to use the default settings in this function.
        benchmark (bool, optional): whether the experiment is in benchmark mode. If true, disable the randomization at inverters filter. Defaults to False.
        percentage_hack (float, optional): percentage hack for all devices. Defaults to 0.45. Only have meaning when benchmark is True.
        adv (bool, optional): whether the experiment is adversarial training. Defaults to False. If True, set the advesarial devices to use RL controllers.

    Returns:
        dict: a dictionary contains full information to run the experiment.
    """
