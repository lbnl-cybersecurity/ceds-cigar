...
class PyCIGARFBSAPI(object):
    ...
    def simulation_command(self, command):
        ...
        self.fbs = FBS(command.split()[1].strip('"'))
    ...
    def update_all_bus_voltages(self):
        self.puvoltage = self.fbs.get_all_bus_voltages() #work around this
    ...
    def set_node_kw(self, node_id, value):
        """Set node kW."""
        self.fbs.set_load_kw(node_id, value)

    def set_node_kvar(self, node_id, value):
        """Set node kVar."""
        self.fbs.set_load_kvar(node_id, value)
