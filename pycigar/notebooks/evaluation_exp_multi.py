...
def policy_mapping_fn(agent_id):
    aid = int(re.sub('[^0-9]', '', agent_id))
    if aid in [701, 712, 742, 729, 744, 727, 728]:
        return "agent_1"
    elif aid in [713, 722, 724, 720, 725, 714, 718]:
        return "agent_2"
    elif aid in [730, 732, 731, 733, 736, 734, 735, 737, 738, 740, 741]:
        return "agent_3"
    else:
        return "agent_3"
...
if __name__ == '__main__':
    ...
    if args.unbalance:
        ...
        pycigar_params = {'exp_tag': 'cooperative_multiagent_ppo',
                          'env_name': 'MultiControlPVInverterEnv',
                          'simulator': 'opendss'}
    ...
    base_config = {
        ...
        'train_batch_size': max(500, 20*args.workers), #256, #250
        'clip_param': 0.1,
        'lambda': 0.95,
        'vf_clip_param': 100,
        ...
        # ==== MULTI AGENT =======
        "multiagent": {
            "policies_to_train": ["agent_1", "agent_2", "agent_3"],
            "policies": {
                "agent_1": (PPOTFPolicy, obs_space, act_space, model),
                "agent_2": (PPOTFPolicy, obs_space, act_space, model),
                "agent_3": (PPOTFPolicy, obs_space, act_space, model)
            },
