...
def parse_cli_args():
    ...
    parser.add_argument('--feeder', type=str, default='ieee37', help='feeder to use')
...
if __name__ == '__main__':
    ...
    base_config['env_config']['P'] = 1
    base_config['env_config']['Q'] = 1
    base_config['env_config']['T'] = 300
    ...
    for i in range(1):
        ...
        config['config']['lr'] = ray.tune.grid_search([1e-3, 5e-3])
