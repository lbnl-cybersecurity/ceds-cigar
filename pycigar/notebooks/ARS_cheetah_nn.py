...
def parse_cli_args():
    ...
    parser.add_argument('--save-path', type=str, default='~/ars_cheetah_nn', help='where to save the results')
...
if __name__ == '__main__':
    ...
    np.savetxt(os.path.join(save_path, 'ARS_cheetah_theta2.csv'), thetas2[-1], delimiter=',')
