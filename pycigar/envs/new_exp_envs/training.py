...
if __name__ == '__main__':
    ...
    if args.unbalance:
        pycigar_params = {'exp_tag': 'cooperative_multiagent_ppo',
                          'env_name': 'NewExpCentralControlPhaseSpecificPVInverterEnv',
                          'simulator': 'opendss'}
    else:
        pycigar_params = {'exp_tag': 'cooperative_multiagent_ppo',
                          'env_name': 'NewExpCentralControlPhaseSpecificPVInverterEnv',
    ...
    base_config = {
        ...
        'rollout_fragment_length': 700,
        'train_batch_size': 200*args.workers, #256, #250
        'clip_param': 0.1,
        'lambda': 0.95,
        'vf_clip_param': 100,
    ...
    for i in range(1):
        ...
        config['config']['env_config']['T'] = ray.tune.grid_search([15])
