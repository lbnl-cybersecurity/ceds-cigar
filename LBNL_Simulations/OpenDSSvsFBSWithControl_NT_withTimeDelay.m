...
% Delays
Delay_VoltageSampling = [0 0 0 10 10 10 0 0 10 0 10 10 10]; 
Delay_VBPCurveShift = [0 0 0 120 120 120 0 0 120 0 120 120 120]; 
...
for ksim=1:TotalTimeSteps
   ...
   if(ksim > 1 && ksim < TotalTimeSteps)
        for node_iter = 1:NumberOfLoads
            ...
            InverterReactivePower(ksim-1,knode),InverterRealPower(ksim-1,knode),...
